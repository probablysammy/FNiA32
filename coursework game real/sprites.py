...
class Player(pygame.sprite.Sprite): #inherits from pygame sprite module
    ...
    def __init__(self, game, x, y):
        ...
        #sprite image
        image_to_load = pygame.image.load("img/cat.png") #load sprite image
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        image_to_load = pygame.image.load("img/evil.png")
...
class Block(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        image_to_load = pygame.image.load("img/wall.png") #load sprite image
        self.image = pygame.Surface([self.width, self.height])
        self.image.blit(image_to_load, (0,0))
...
class Ground(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        image_to_load = pygame.image.load("img/grass.png") #load sprite image
        self.image = pygame.Surface([self.width, self.height])
        self.image.blit(image_to_load, (0,0))
